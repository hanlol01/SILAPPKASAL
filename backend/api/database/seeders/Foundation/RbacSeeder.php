...
class RbacSeeder extends Seeder
{
    ...
    private array $roles = [
        ...
        'admin' => [
            'name' => 'Admin',
            'description' => 'Memverifikasi pengaduan masuk, routing, user management, dan statistik.',
        ],
        'satgas_ppks' => [
            'name' => 'Satgas PPKS',
        ...
        'reporter' => [
            'name' => 'Pelapor',
            'description' => 'Membuat pengaduan dan memantau status kasus sendiri.',
        ],
    ];
    ...
    private array $permissions = [
        ...
        'reports.create' => ['name' => 'Create Complaints', 'description' => 'Membuat pengaduan baru', 'module' => 'Pengaduan'],
        'reports.read.own' => ['name' => 'Read Own Complaints', 'description' => 'Melihat pengaduan sendiri', 'module' => 'Pengaduan'],
        'reports.read.all' => ['name' => 'Read All Complaints', 'description' => 'Melihat semua pengaduan masuk', 'module' => 'Pengaduan'],
        'reports.verify' => ['name' => 'Verify Complaints', 'description' => 'Memverifikasi pengaduan', 'module' => 'Pengaduan'],
        'reports.reject' => ['name' => 'Reject Complaints', 'description' => 'Menolak pengaduan', 'module' => 'Pengaduan'],
        'reports.forward' => ['name' => 'Forward Complaints', 'description' => 'Meneruskan pengaduan ke Satgas', 'module' => 'Pengaduan'],
        'reports.request_info' => ['name' => 'Request Complaint Info', 'description' => 'Meminta info tambahan dari pelapor', 'module' => 'Pengaduan'],
        'reports.cancel.own' => ['name' => 'Cancel Own Complaint', 'description' => 'Membatalkan pengaduan sendiri sebelum penanganan dimulai', 'module' => 'Pengaduan'],
        'reports.withdraw.own' => ['name' => 'Withdraw Own Complaint', 'description' => 'Mengajukan pencabutan formal pengaduan sendiri', 'module' => 'Pengaduan'],
        'reports.withdraw.review.own_campus' => ['name' => 'Review Campus Complaint Withdrawals', 'description' => 'Meninjau pencabutan pengaduan pada kampus sendiri', 'module' => 'Pengaduan'],
        ...
        'case_minutes.read' => ['name' => 'Read Case Minutes', 'description' => 'Melihat Berita Acara Kasus sesuai cakupan peran', 'module' => 'Kasus'],
        'case_minutes.write' => ['name' => 'Write Case Minutes', 'description' => 'Membuat, memperbarui, dan merevisi draf Berita Acara Kasus', 'module' => 'Kasus'],
        'case_minutes.finalize' => ['name' => 'Finalize Case Minutes', 'description' => 'Memfinalkan Berita Acara Kasus pada kampus sendiri', 'module' => 'Kasus'],
        'case_documents.issue' => ['name' => 'Issue Case Closure Documents', 'description' => 'Menerbitkan Berita Acara Hasil Pelaporan setelah kasus ditutup', 'module' => 'Kasus'],
        'case_documents.download.own' => ['name' => 'Download Own Case Closure Document', 'description' => 'Mengunduh Berita Acara Hasil Pelaporan milik sendiri', 'module' => 'Kasus'],
        'case_documents.download.assigned' => ['name' => 'Download Assigned Case Closure Document', 'description' => 'Mengunduh Berita Acara Hasil Pelaporan pada kasus yang ditugaskan', 'module' => 'Kasus'],
        'case_documents.download.own_campus' => ['name' => 'Download Campus Case Closure Document', 'description' => 'Mengunduh Berita Acara Hasil Pelaporan pada kampus sendiri', 'module' => 'Kasus'],
        'case_documents.download.all' => ['name' => 'Download All Case Closure Documents', 'description' => 'Mengunduh Berita Acara Hasil Pelaporan untuk pengawasan Super Admin', 'module' => 'Kasus'],
        ...
        'reporter_evidence.read.own' => ['name' => 'Read Own Reporter Evidence', 'description' => 'Melihat lampiran bukti pada pengaduan sendiri', 'module' => 'Bukti Pelapor'],
        'reporter_evidence.upload.own' => ['name' => 'Upload Own Reporter Evidence', 'description' => 'Mengunggah lampiran bukti pada pengaduan sendiri', 'module' => 'Bukti Pelapor'],
        'reporter_evidence.download.own' => ['name' => 'Download Own Reporter Evidence', 'description' => 'Mengunduh lampiran bukti pada pengaduan sendiri', 'module' => 'Bukti Pelapor'],
    ...
    private array $rolePermissions = [
        ...
        'admin' => [
            ...
            'case_minutes.read',
            'case_minutes.write',
            'case_minutes.finalize',
            'case_documents.issue',
            'case_documents.download.own_campus',
            'dashboard.admin',
            'statistics.view',
            'statistics.export',
        ...
        'satgas_ppks' => [
            ...
            'case_documents.download.assigned',
            'content.read.published',
        ],
        'reporter' => [
            'reports.create',
