...
class MasterDataSeeder extends Seeder
{
    ...
    private function seedRecommendationStatuses(): void
    {
        $rows = [
            ...
            ['RECS-03', RecommendationStatusEnum::SubmittedForReview->value, 'Rekomendasi diajukan untuk peninjauan Admin Kampus.', []],
            ['RECS-04', RecommendationStatusEnum::Accepted->value, 'Rekomendasi disetujui oleh Admin Kampus.', []],
    ...
    private function seedNotificationTypes(): void
    {
        $rows = [
            ...
            ['NOTIF-14', 'Rekomendasi diajukan untuk peninjauan', 'Admin Kampus', 'in_app', 'recommendation.submitted_for_review', 'mvp_extended'],
            ...
            ['NOTIF-26', 'Permohonan pencabutan menunggu verifikasi', 'Admin', 'in_app', 'report.formal_withdrawal.submitted', 'mvp_extended'],
            ['NOTIF-27', 'Permohonan pencabutan dibatalkan Pelapor', 'Admin', 'in_app', 'report.formal_withdrawal.cancelled', 'mvp_extended'],
            ['NOTIF-28', 'Permohonan pencabutan disetujui', 'Reporter', 'in_app', 'report.formal_withdrawal.approved', 'mvp_extended'],
            ['NOTIF-29', 'Permohonan pencabutan ditolak', 'Reporter', 'in_app', 'report.formal_withdrawal.rejected', 'mvp_extended'],
            ['NOTIF-30', 'Berita Acara difinalkan', 'Pembuat draf dan Satgas aktif', 'in_app', 'case.minutes.finalized', 'mvp_extended'],
        ];
