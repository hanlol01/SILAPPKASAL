...
const API_ERROR_KEYS: Record<string, string> = {
  ...
  content_stale_review: "contentGovernance:review.stale",
  content_invalid_lifecycle_transition: "contentGovernance:review.invalidTransition",
  content_featured_stale: "contentGovernance:featured.stale",
  content_featured_conflict: "contentGovernance:featured.conflict",
